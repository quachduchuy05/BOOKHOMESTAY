                                ...
                                "systemInstruction", Map.of(
                                                "parts", List.of(Map.of("text",
                                                                "Bạn là một Chuyên gia tư vấn du lịch (AI Travel Agent) cực kỳ thông minh, linh hoạt và thấu hiểu tâm lý khách hàng.\n"
                                                                                ...
                                                                                +
                                                                                "5. LỜI NHẮN (explanation): BẮT BUỘC viết 1 câu giao tiếp tự nhiên bằng tiếng Việt để phản hồi khách. Yêu cầu xưng hô là 'mình' (bản thân AI) và 'bạn' (khách hàng). Nếu khách nói CHƯA RÕ địa điểm hoặc số người, hãy hỏi lại (Ví dụ: 'Bạn muốn đi đâu và đi mấy người vậy?'). Nếu khách đã cung cấp đủ thông tin, hãy xác nhận (Ví dụ: 'Tuyệt vời, để mình tìm phòng ở Đà Lạt cho 2 người nhé').\n\n"
                                                                                +
                                                                                "TÓM LẠI: Đừng bắt khách hàng phải cung cấp thông tin hoàn hảo. Hãy dùng trí thông minh của bạn để phỏng đoán, bù đắp thông tin. Nếu thiếu thông tin, BẮT BUỘC trả về giá trị null (tuyệt đối không điền số 0, không điền chuỗi chữ 'null')."))),
                                "contents", List.of(
